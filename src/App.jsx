  ...
  return (
   <div className="h-screen w-full flex flex-col items-center justify-center bg-slate-50 p-4 text-center">
    <div className="bg-white p-8 rounded-3xl border border-slate-200  max-w-sm w-full">
     ...
     <button 
      onClick={signOut}
      className="w-full bg-slate-950 text-white border border-slate-900 px-5 py-2.5 rounded-2xl font-bold hover:bg-black transition-all  shadow-none"
     >
      Keluar & Coba Lagi
     </button>
    </div>
 ...
 return (
  <div className="flex h-screen w-full overflow-hidden bg-slate-50">
   ...
   <div className="flex flex-col flex-1 min-w-0 h-screen overflow-hidden ml-64">
    <Header />
    <main className="flex-1 overflow-y-auto pt-20 md:pt-24 p-4 md:p-8">
