...
function useMenuPosition(clientRect) {
...
function createSuggestionRender(MenuComponent) {
 return () => {
  let component = null
  let container = null
  let selectedIndex = 0
...
export const MentionMenu = React.forwardRef(function MentionMenu(props, ref) {
    ...
    >
     {items.length === 0 ? (
      ...
      items.map((item, index) => {
       ...
       const Icon = isCommand ? item.icon : Hash
...
export const EmojiMenu = React.forwardRef(function EmojiMenu(props, ref) {
 const { items, selectedIndex, onSelect, clientRect } = props
 const { refs, floatingStyles, isPositioned } = useMenuPosition(clientRect)
...
export const createMentionConfig = (users) => {
 return {
  char: '@',
...
export const createSuggestionConfig = (char, getItems) => {
 return {
  char,
...
export const createEmojiSuggestionConfig = (allEmojis, options) => {
