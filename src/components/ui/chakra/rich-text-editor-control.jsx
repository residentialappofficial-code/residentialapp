...
export function createBooleanControl(config) {
  const {
    label,
    icon: Icon,
    isDisabled,
  ...
  const BooleanControl = React.forwardRef(function BooleanControl(props, ref) {
...
export function createSelectControl(config) {
  const {
    label,
    options,
    width,
  ...
  const SelectControl = React.forwardRef(function SelectControl(props, ref) {
    const { editor } = useRichTextEditorContext()
...
export function createSwatchControl(config) {
  const {
    label,
    swatches,
    getValue,
  ...
  const SwatchControl = React.forwardRef(function SwatchControl(props, ref) {
    const { editor } = useRichTextEditorContext()
...
const TEXT_STYLE_OPTIONS = [
  ...
  { value: 'horizontalRule', label: 'Divider', icon: <Minus /> },
]
