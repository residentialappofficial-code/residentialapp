import { Search, Bell, ChevronDown, Building2, Sparkles } from "lucide-react";
...
export function Header() {
  ...
  return (
    <header className="fixed top-0 right-0 left-64 h-16 bg-white/80 backdrop-blur-md border-b border-slate-200 z-40 px-6">
